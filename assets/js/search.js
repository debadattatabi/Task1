...
$(document).ready(function(){
  $("#search_items1").keypress(function(){
    $("#columns").hide();
...
'<a href="http://uae.souqplace.com/products/{{sku}}/{{seourl}}/{{seller_product_id}}"><img class="img-responsive lazy" alt="product" data-original="/assets_new/images/logo.png" src="{{image}}"></a><div class="quick-view"><a title="Add to my wishlist" class="heart" href="#" data-mywhichlist="" data-id="{{sku}}/{{seourl}}/{{seller_product_id}}" data-type="Fresh" style=""></a><a title="Quick view" class="search" href="#" data-id="{{sku}}/{{seourl}}/{{seller_product_id}}"></a></div><div class="add-to-cart"><a title="Add to Cart" href="#" class="search" data-id="{{sku}}/{{seourl}}/{{seller_product_id}}">Add to Cart</a></div></div><div class="right-block"><h5 class="product-name"><a href="http://uae.souqplace.com/products/{{sku}}/{{seourl}}/{{seller_product_id}}" style="">{{product_name}}</a></h5><div class="content_price"><p class="price product-price">{{sale_price}} AED</p><p class="price old-price" style="text-decoration: none"><strike>{{old_price}}</strike> &nbsp;</p></div><div class="info-orther"><p>Item Code: {{sku}}</p><p class="availability">Availability: <span>In Stock</span></p><div class="product-desc" style="text-align:justify">{{product_name}}</div></div></div></div></div></li>';
